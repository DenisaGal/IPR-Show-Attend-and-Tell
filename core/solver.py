...
from core.mybleu import evaluate
...
class CaptioningSolver(object):
    def __init__(self, model, data, val_data, **kwargs):
        ...
        self.batch_size = kwargs.pop('batch_size', 1)#was 100
        self.update_rule = kwargs.pop('update_rule', 'adam')
        self.learning_rate = kwargs.pop('learning_rate', 0.01)
        self.print_bleu = kwargs.pop('print_bleu', False)
        self.print_every = kwargs.pop('print_every', 20) #was 100
            ...
            for e in range(self.n_epochs):
                ...
                for i in range(n_iters_per_epoch):
                    ...
                    if (i+1) % self.print_every == 0:
                        print("\nTrain loss at epoch ", e+1, " & iteration ", i+1, " (mini-batch): ", l)
                        ground_truths = captions[image_idxs == image_idxs_batch[0]]
                        decoded = decode_captions(ground_truths, self.model.idx_to_word)
                        for j, gt in enumerate(decoded):
                            print("Ground truth", j+1, ": ", gt)
                ...
                if self.print_bleu:
                    ...
                    scores = eval(data_path='./data', split='val', get_scores=True)
    ...
    def test(self, data, split='train', attention_visualization=True, save_sampled_captions=True):
        ...
        with tf.Session(config=config) as sess:
            ...
            if attention_visualization:
                for n in range(10):
                    print("Sampled Caption: ", decoded[n])
