...
def _process_caption_data(caption_file, image_dir, max_length):
    ...
    print("The number of captions before deletion: " , len(caption_data))
    caption_data = caption_data.drop(caption_data.index[del_idx])
    caption_data = caption_data.reset_index(drop=True)
    print("The number of captions after deletion: ", len(caption_data))
    return caption_data
...
def _build_vocab(annotations, threshold=1):
    ...
    print('Filtered ', len(counter), ' words to ', len(vocab), ' words with word count threshold ', threshold,'.')
...
def main():
    ...
    batch_size = 10 #This was 100 but had to reduce it for memory reasons
    ...
    for split in ['train', 'val', 'test']:
        ...
        print("Finished building ", split, " caption dataset")
    ...
    with tf.Session() as sess:
        ...
        for split in ['train', 'val', 'test']:
            ...
            for start, end in zip(range(0, n_examples, batch_size),
                ...
                print("Processed ", (end, split), " features..")
